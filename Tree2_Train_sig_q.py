...
class train(tf.keras.Model):
    ...
    def call(self, Y):
        ...
        for n in range(0, int(period)):
            ...
            q1_tilde, q2_tilde, q3_tilde, sig_q1_Z1, sig_q1_Z2, sig_q2_Z1, sig_q2_Z2, sig_q3_Z1, sig_q3_Z2 = self.net(Y2, Y3)
...
class train_solver(tf.Module):  # network training
    ...
    def __init__(self, vecpar, initial_state, shared_layers):
        ...
        self.model.net.load_weights('./ckpt/Tree2_sig_q_init/my_checkpoint')
        ...
        for it in range(epoch):
            ...
            if (it+1) % 10 == 0:
                ...
                if train_loss <= train_loss_threshold:
                    self.model.net.save_weights('./ckpt/Tree2_sig_q_minloss/my_checkpoint')
